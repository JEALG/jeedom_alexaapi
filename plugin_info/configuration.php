...
<center>
	...
	<a class="btn btn-warning btn-sm bt_identificationCookie2"><i class="far fa-clock"></i> {{... Attendez la génération du Cookie Amazon ...}} </a>
	<a class="btn btn-default btn-sm bt_identificationCookie2bis"><i class="far fa-clock"></i> {{... Attendez la génération du Cookie Amazon ...}} </a>
	<a class="btn btn-danger btn-sm bt_identificationCookie2echec"><i class="fas fa-times"></i> {{La génération du Cookie Amazon a échoué}} </a>
	<a class="btn btn-success btn-sm bt_identificationCookie3"><i class="fas fa-check"></i> {{Bravo : Cookie d'identification Amazon chargé !}} </a>
	<a class="btn btn-primary btn-sm bt_identificationCookie"><i class="fas fa-spinner fa-spin"></i> {{Ouverture de la fenetre d'identification Amazon Alexa en cours ...}} </a>
	<a class="btn btn-default btn-sm bt_identificationCookie1"><i class="fas fa-spinner fa-spin"></i> {{Cliquez ici quand vous avez terminé l'identification}} </a>
	<br><br>
</center>
...
<form class="form-horizontal">
	<fieldset>
		<legend><i class="fas fa-list-alt"></i> {{Profil Utilisateur}}</legend>
		<div class="form-group">
...
<script>
	$("#bt_saveUpdateRoutines").on('click', function(event) {
		...
		jeedom.config.save({
			...
			configuration: {
				listRoutinesValidFin: heureMaintenant
			},
			...
			success: function() {
				...
				$('#md_modal').dialog({
					title: "{{Configuration du plugin (après Reset validité Routines)}}"
				});
